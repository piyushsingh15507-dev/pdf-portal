...
try:
    ...
    master_query = master_parsed.query # preserves Expires, hmac, userIds, key
    ...
    # Append master query parameters to the sub-playlist URI if it doesn't already have them
    if "?" in sub_playlist_uri:
    ...
    # Preserve signature on segment requests!
